					...
					<div class="media">
						<div class="d-flex flex-column vote-controls">
							...
							@can('accept', $answer)
								...
								<form id="accept-answer-{{$answer->id}}" action="{{route('answers.accept',$answer->id)}}" method="post" hidden>
									@csrf
								</form>
							@else
								@if ($answer->is_best)
									<a title="This is the best answer" class="{{$answer->status}} mt-2" href="#">
										<i class="fas fa-check fa-2x"></i>
									</a>
								@endif
							@endcan
							...
							<div class="row">
								...
								<div class="col-4">
									...
									<div class="media mt-2">
										<a href="{{$answer->user->url}}" class="pr-2"><img src="{{$answer->user->avatar}}" alt="author image"></a>
